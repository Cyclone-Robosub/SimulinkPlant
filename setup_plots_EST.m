...
plots{1} = TimePlot("pwm_cmd","pwms",[4,2],{1,2,3,4,5,6,7,8},["pwm (us)","pwm (us)", "pwm (us)", "pwm (us)", "pwm (us)", "pwm (us)", "pwm (us)", "pwm (us)"],"Time (s)", ["Thruster 0","Thruster 1", "Thruster 2", "Thruster 3", "Thruster 4", "Thruster 5", "Thruster 6", "Thruster 7"],"Commanded Thruster PWM",{"","","","","","","",""});
...
%new plot
%plots{end+1} = TimePlot("X_compare",["real.Rb", "real.dRb", "real.Eul", "real.wb"],[2,2],{[1,2,3,4,5,6],[13,14,15,16,17,18],[7,8,9,10,11,12],[19,20,21,22,23,24]},["Position (m)","Angle (rad)","Velocity (m/s)","Angular Velocity (rad/s)"],"Time (s)",["Body Frame Position", "Euler Angles","Body Frame Velocity","Angular Velocity"],"Simulated States",{["Rix", "Riy", "Riz","Rix_sim", "Riy_sim", "Riz_sim"],["Roll", "Pitch", "Yaw","Roll_sim", "Pitch_sim", "Yaw_sim"],["dRbx", "dRby", "dRbz","dRbx_sim", "dRby_sim", "dRbz_sim"],["wbx","wby","wbz","wbx_sim","wby_sim","wbz_sim"]});