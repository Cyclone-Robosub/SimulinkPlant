...
## Generated on : Sat Apr 19 19:10:58 2025
...
DEFINES_STANDARD = -DMODEL=Controller -DNUMST=2 -DNCSTATES=12 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/IntelWin64/Controller/Controller.cpp $(START_DIR)/IntelWin64/Controller/Controller_data.cpp

MAIN_SRC = $(START_DIR)/IntelWin64/Controller/ert_main.cpp
...
%.obj : $(START_DIR)/IntelWin64/Controller/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/IntelWin64/Controller/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/IntelWin64/Controller/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/IntelWin64/Controller/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/IntelWin64/Controller/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Controller.obj : $(START_DIR)/IntelWin64/Controller/Controller.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Controller_data.obj : $(START_DIR)/IntelWin64/Controller/Controller_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/IntelWin64/Controller/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
