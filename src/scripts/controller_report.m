...
mask = true(size(squeeze(results.joystick_mode_enabled_flag.Data)));
...
subplot(2,1,1)
plot(t(mask), eul(mask,1),'Color','r')
hold on
plot(t(mask), eul_u(mask,1),'Color','g','LineStyle','--')
title("Roll Controller")
xlabel("Time (s)")
ylabel("Angle (rad)")
legend(["Roll", "Roll SP"])
subplot(2,1,2)
plot(t(mask), wb(mask,1),'Color','r')
hold on
plot(t(mask), wb_u(mask,1),'Color','g', 'LineStyle','--')
...
subplot(2,1,1)
plot(t(mask), eul(mask,2),'Color','r')
hold on
plot(t(mask), eul_u(mask,2),'Color','g','LineStyle','--')
title("Pitch Controller")
xlabel("Time (s)")
ylabel("Angle (rad)")
legend(["Pitch", "Pitch SP"])
subplot(2,1,2)
plot(t(mask), wb(mask,2),'Color','r')
hold on
plot(t(mask), wb_u(mask,2),'Color','g', 'LineStyle','--')
...
subplot(2,1,1)
plot(t(mask), eul(mask,3),'Color','r')
hold on
plot(t(mask), eul_u(mask,3),'Color','g','LineStyle','--')
title("Yaw Controller")
xlabel("Time (s)")
ylabel("Angle (rad)")
legend(["Yaw", "Yaw SP"])
subplot(2,1,2)
plot(t(mask), wb(mask,3),'Color','r')
hold on
plot(t(mask), wb_u(mask,3),'Color','g', 'LineStyle','--')
...
subplot(2,1,1)
plot(t(mask), Rb(mask,1),'Color','r')
hold on
plot(t(mask), Rb_u(mask,1),'Color','g','LineStyle','--')
title("X Controller")
xlabel("Time (s)")
ylabel("Position (m)")
legend(["X", "X SP"])
subplot(2,1,2)
plot(t(mask), dRb(mask,1),'Color','b')
hold on
plot(t(mask), dRb_u(mask,1),'Color','r', 'LineStyle','--')
title("dX Controller")
xlabel("Time (s)")
ylabel("Velocity (m/s)")
legend(["dX", "dX SP"])
...
subplot(2,1,1)
plot(t(mask), Rb(mask,2),'Color','r')
hold on
plot(t(mask), Rb_u(mask,2),'Color','g','LineStyle','--')
title("Y Controller")
xlabel("Time (s)")
ylabel("Position (m)")
legend(["Y", "Y SP"])
subplot(2,1,2)
plot(t(mask), dRb(mask,2),'Color','r')
hold on
plot(t(mask), dRb_u(mask,2),'Color','g', 'LineStyle','--')
title("dY Controller")
xlabel("Time (s)")
ylabel("Velocity (m/s)")
legend(["dY", "dY SP"])
...
subplot(2,1,1)
plot(t(mask), force_cmd(mask,1),'Color','r')
hold on
plot(t(mask), force_cmd(mask,2),'Color','g')
plot(t(mask), force_cmd(mask,3),'Color','b')
title("Force Command")
xlabel("Time (s)")
ylabel("Force (N)")
legend(["Fbx", "Fby", "Fbz"])
subplot(2,1,2)
plot(t(mask), moment_cmd(mask,1),'Color','r')
hold on
plot(t(mask), moment_cmd(mask,2),'Color','g')
plot(t(mask), moment_cmd(mask,3),'Color','b')
