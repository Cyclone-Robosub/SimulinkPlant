...
% See setup_default_maneuvers for id to maneuver key
switch(id)
    case 1
        thruster_mask = int.*masks(:,1);
    case 2
        thruster_mask = int.*masks(:,2);
    case 3
        thruster_mask = int.*masks(:,3);
    case 4
        thruster_mask = int.*masks(:,4);
    case 5
        thruster_mask = int.*masks(:,5);
    case 6
        thruster_mask = int.*masks(:,6);
    case 7
        thruster_mask = int.*masks(:,7);
    case 8
        thruster_mask = int.*masks(:,8);
    case 9
        thruster_mask = int.*masks(:,9);
    case 10 
        thruster_mask = int.*masks(:,10);
    case 11
        thruster_mask = int.*masks(:,11);
    case 12
        thruster_mask = int.*masks(:,12);
    case 0
