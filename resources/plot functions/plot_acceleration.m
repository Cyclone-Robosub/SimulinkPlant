...
%unpack input signal
figure
Abe_b_meas = squeeze(results.Abe_b_meas.Data)';
...
hold on
plot(results.Abe_b_meas.Time,Abe_b_meas(:,1),'color','r')
...
ylabel("Acceleration (m/s^2)")
hold on
plot(results.Abe_b_meas.Time,Abe_b_meas(:,2),'color','r')
...
ylabel("Acceleration (m/s^2)")
hold on
plot(results.Abe_b_meas.Time,Abe_b_meas(:,3),'color','r')
