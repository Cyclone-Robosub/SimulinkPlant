...
DEFINES_STANDARD = -DMODEL=Controller -DNUMST=2 -DNCSTATES=12 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/Controller_grt_rtw/Controller.c $(START_DIR)/Controller_grt_rtw/Controller_data.c $(START_DIR)/Controller_grt_rtw/rtGetNaN.c $(START_DIR)/Controller_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.obj Controller.obj Controller_data.obj rtGetNaN.obj rt_nonfinite.obj
